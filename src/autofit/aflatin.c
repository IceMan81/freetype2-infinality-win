...
FT_Pos infinality_cur_width = 0;
                              ...
                              AF_Dimension     dim )
  {
    ...
    if ( checked_adjust_heights_env == 0 )
    {
      ...
      {
        if ( _stricmp(adjust_heights_env, "default" ) != 0 )
        {
          if ( _stricmp(adjust_heights_env, "true") == 0 )
            adjust_heights = TRUE;
          else if ( _stricmp(adjust_heights_env, "1") == 0 )
            adjust_heights = TRUE;
          else if ( _stricmp(adjust_heights_env, "on") == 0 )
            adjust_heights = TRUE;
          else if ( _stricmp(adjust_heights_env, "yes") == 0 )
            adjust_heights = TRUE;
        }
      }
